    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        switch (viewType) {
            case CartItemModel.CART_ITEM:
                View cartItemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_cart_item_layout, viewGroup, false);
                return new CartItemViewholder(cartItemView);

            case CartItemModel.TOTAL_AMOUNT:
                View cartTotalview = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_cart_total_amount_layout, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        switch (cartItemModelList.get(position).getType()) {
            ...
            case CartItemModel.TOTAL_AMOUNT:
                ...
                cartItemModelList.get(position).setDeliveryPrice(deliverPrice);
    ...
    class CartItemViewholder extends RecyclerView.ViewHolder {
        ...
        private void setItemDetails(final String productID, String resource, String title, Long freeCoupensNo, final String productPriceText, String cuttedPriceText, Long offersAppliedNo, final int position, final boolean inStock, final String quantity, final Long maxQuantity, boolean qtyError, final List<String> qtyIds, final long stockQty, boolean COD) {
            ...
            if (inStock) {
                ...
                applyORremoveBtnContainer = checkCoupenPriceDialog.findViewById(R.id.coupen_apply_or_remove_btns);
                ...
                productQuantity.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        final EditText quantityNo = quantityDialog.findViewById(R.id.quantiyt_no);
