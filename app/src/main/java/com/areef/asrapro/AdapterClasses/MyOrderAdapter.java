...
import com.areef.asrapro.OrderDetailsActivity;
...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.Viewholder> {
    ...
    public MyOrderAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_my_order_item_layout, viewGroup, false);
    ...
    class Viewholder extends RecyclerView.ViewHolder {
        ...
        private void setData(String resource, String title, String orderStatus, Date date, final int rating, final String productID, int position) {
