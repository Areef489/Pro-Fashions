...
import com.areef.asrapro.AddAddressActivity;
...
import static com.areef.asrapro.DeliveryActivity.SELECT_ADDRESS;
import static com.areef.asrapro.Fragments.MyAccountFragment.MANAGE_ADDRESS;
import static com.areef.asrapro.MyAddressesActivity.refreshItem;
...
public class AddressesAdapter extends RecyclerView.Adapter<AddressesAdapter.Viewholder> {
    ...
    public AddressesAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_addresses_item, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull AddressesAdapter.Viewholder viewholder, int position) {
        ...
        viewholder.setData(name, city, pincode, selected, position, mobileNo, alternateMobileNo, flatNo, street, state, landmark);
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        private void setData(String username, String city, String userPincode, Boolean selected, final int position, String mobileNo, String alternateMobileNo, String flatNo, String street, String state, String landmark) {
            ...
            if (MODE == SELECT_ADDRESS) {
                    ...
                    public void onClick(View v) {///remove address
                        ...
                        for (int i = 0; i < addressesModelList.size(); i++) {
                            if (i != position) {
                                ...
                                addresses.put("street_" + x, addressesModelList.get(i).getStreet());
                ...
                icon.setImageResource(R.drawable.vertical_dots_icon);
